  ...
  class BacklogBucketsController < BaseController
    ...
    def create # rubocop:disable Metrics/AbcSize
      ...
      if call.success?
        ...
        update_new_sprint_form_component_via_turbo_stream(backlog_bucket: call.result, base_errors: call.errors[:base])
    ...
    def update_new_sprint_form_component_via_turbo_stream(backlog_bucket:, base_errors: nil)
