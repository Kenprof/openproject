...
module Wikis
  ...
  RSpec.describe PageLinkMetadataService do
    ...
    before do
      ...
      query_double = instance_double(Adapters::Providers::Internal::Queries::Test)
      allow(Adapters::Providers::Internal::Queries::Test).to receive(:new).with(provider).and_return(query_double)
